...
cannot access. We show that their core methodology --- human-grounded personas,
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/fig9_ui_data.png}
...
\begin{figure*}[t]
\centering
\includegraphics[width=.92\textwidth]{figures/fig8_ui_adherence.png}
